...
The organization-wide ORES telemetry, Opto Sync, Shared Auth/Supabase, and Zed
dependency invariants are defined by the executable
[`platform integration contract`](docs/PLATFORM_INTEGRATIONS.md).

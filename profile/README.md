...
- [GitHub Project: benefactor-cc-project](https://github.com/orgs/benefactor-cc/projects/1)
- [Linear planning project](https://linear.app/denman/project/githubcombenefactor-cc-6bef502a1ef0)
...
This GitHub account maintains software, infrastructure, research, and supporting documentation under the [`benefactor-cc`](https://github.com/benefactor-cc) GitHub owner.

Planning and delivery context is tracked in [github.com/benefactor-cc](https://linear.app/denman/project/githubcombenefactor-cc-6bef502a1ef0). Public contribution, security, and governance defaults are maintained in [`.github`](https://github.com/benefactor-cc/.github).

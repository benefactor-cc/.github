...
- Organization defaults: https://github.com/benefactor-cc/.github
- Canonical agent policy: https://github.com/benefactor-cc/.github/blob/main/agents.md
- Security policy: https://github.com/benefactor-cc/.github/security/policy
...
`benefactor-cc` declares repository roles, dependency edges, cross-organization capabilities, deployment ownership, and the git-submodule/Zed-package contract:
